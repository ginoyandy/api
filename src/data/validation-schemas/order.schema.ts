...
export const OrderValidationSchema = object({
  body: object({
    ...
    enrollmentNumber: string().required('El número de matrícula es requerido. '),
    folioNumber: string().required('El número de folio es requerido. '),
    volumeNumber: string().required('El número de tomo es requerido. '),
